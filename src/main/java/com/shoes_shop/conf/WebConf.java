...
public class WebConf implements WebMvcConfigurer {
	...
	@Bean public ViewResolver viewResolver() {
		...
		//khai báo đường dẫn vào bên trong index của trang web
	...
	public void addResourceHandlers(final ResourceHandlerRegistry registry) {
		//khai báo đường dẫn vào bên trong tài nguyên của web : css,js,images,assets ...
		...
		registry.addResourceHandler("/file/uploads/**").addResourceLocations("file:D:\\cong_cu_phat_trien_phan_mem\\Website-ban-giay-dep-java-mysql\\shoe_shop_springboot_application\\com.shoes_shop.duc\\uploads\\");
	}
